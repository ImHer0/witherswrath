...
execute at @e[type=player,distance=..50] run summon wither_skeleton ~ ~5 ~ {DeathLootTable: "wither:entities/withermobs", Attributes: [{Name: "generic.max_health", Base: 80}], Health: 80}
execute as @e[type=wither,limit=1,sort=nearest] run summon wither_skeleton ~ ~ ~ {DeathLootTable: "wither:entities/withermobs", Attributes: [{Name: "generic.max_health", Base: 80}], Health: 100, HandItems: [{Count: 1, id: "bow"}], ArmorItems: [{}, {}, {Count: 1, id: "chainmail_chestplate"}]}
execute as @e[type=wither,limit=1,sort=nearest] run summon wither_skeleton ~ ~ ~ {DeathLootTable: "wither:entities/withermobs", Attributes: [{Name: "generic.max_health", Base: 80}], Health: 100, HandItems: [{Count: 1, id: "bow"}], ArmorItems: [{}, {}, {Count: 1, id: "chainmail_chestplate"}]}
execute as @e[type=wither,limit=1,sort=nearest] at @s run summon blaze ~ ~3 ~ {DeathLootTable: "wither:entities/withermobs", Motion: [1.8d, 2d, 0d], Invulnerable: 1, Tags: ["wArcher"], Health:60f,Passengers:[{id:"minecraft:wither_skeleton",Health:55f,HandItems:[{id:"minecraft:bow",count:1},{}],HandDropChances:[0.000F,0.085F],ArmorItems:[{},{},{id:"minecraft:chainmail_chestplate",count:1},{}],ArmorDropChances:[0.085F,0.085F,0.000F,0.085F],attributes:[{id:"minecraft:generic.max_health",base:55},{id:"minecraft:generic.safe_fall_distance",base:100},{id:"minecraft:generic.scale",base:1.25}]}],attributes:[{id:"minecraft:generic.max_health",base:60},{id:"minecraft:generic.scale",base:0.8}]}
execute as @e[type=wither,limit=1,sort=nearest] at @s run summon blaze ~ ~3 ~ {DeathLootTable: "wither:entities/withermobs", Motion: [0d, 2d, 1.8d], Invulnerable: 1, Tags: ["wArcher"], Health:60f,Passengers:[{id:"minecraft:wither_skeleton",Health:55f,HandItems:[{id:"minecraft:bow",count:1},{}],HandDropChances:[0.000F,0.085F],ArmorItems:[{},{},{id:"minecraft:chainmail_chestplate",count:1},{}],ArmorDropChances:[0.085F,0.085F,0.000F,0.085F],attributes:[{id:"minecraft:generic.max_health",base:55},{id:"minecraft:generic.safe_fall_distance",base:100},{id:"minecraft:generic.scale",base:1.25}]}],attributes:[{id:"minecraft:generic.max_health",base:60},{id:"minecraft:generic.scale",base:0.8}]}
execute as @e[type=wither,limit=1,sort=nearest] at @s run summon blaze ~ ~3 ~ {DeathLootTable: "wither:entities/withermobs", Motion: [-1.8d, 2d, 0d], Invulnerable: 1, Tags: ["wArcher"], Health:60f,Passengers:[{id:"minecraft:wither_skeleton",Health:55f,HandItems:[{id:"minecraft:bow",count:1},{}],HandDropChances:[0.000F,0.085F],ArmorItems:[{},{},{id:"minecraft:chainmail_chestplate",count:1},{}],ArmorDropChances:[0.085F,0.085F,0.000F,0.085F],attributes:[{id:"minecraft:generic.max_health",base:55},{id:"minecraft:generic.safe_fall_distance",base:100},{id:"minecraft:generic.scale",base:1.25}]}],attributes:[{id:"minecraft:generic.max_health",base:60},{id:"minecraft:generic.scale",base:0.8}]}
execute as @e[type=wither,limit=1,sort=nearest] at @s run summon blaze ~ ~3 ~ {DeathLootTable: "wither:entities/withermobs", Motion: [0d, 2d, -1.8d], Invulnerable: 1, Tags: ["wArcher"], Health:60f,Passengers:[{id:"minecraft:wither_skeleton",Health:55f,HandItems:[{id:"minecraft:bow",count:1},{}],HandDropChances:[0.000F,0.085F],ArmorItems:[{},{},{id:"minecraft:chainmail_chestplate",count:1},{}],ArmorDropChances:[0.085F,0.085F,0.000F,0.085F],attributes:[{id:"minecraft:generic.max_health",base:55},{id:"minecraft:generic.safe_fall_distance",base:100},{id:"minecraft:generic.scale",base:1.25}]}],attributes:[{id:"minecraft:generic.max_health",base:60},{id:"minecraft:generic.scale",base:0.8}]}
