...
# PEACE
    execute at @e[type=item,sort=nearest,nbt={Item: {id: "minecraft:nether_star"}}] run kill @e[tag=wSkel,type=wither_skeleton,distance=..200]
    execute at @e[type=item,sort=nearest,nbt={Item: {id: "minecraft:nether_star"}}] run kill @e[tag=wSkel,type=blaze,distance=..200]
    execute at @e[type=item,sort=nearest,nbt={Item: {id: "minecraft:nether_star"}}] run kill @e[tag=wSkel,type=zombified_piglin,distance=..200]
