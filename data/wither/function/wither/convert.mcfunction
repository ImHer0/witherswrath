...
execute at @e[type=wither,limit=1,sort=nearest] as @e[limit=1,sort=random,nbt={Tags:["zMarked"]}] at @s run summon zombified_piglin ~ ~.01 ~ {DeathLootTable: "wither:entities/withermobs", Tags: ["wSkel"], Attributes: [{Name: "max_health", Base: 10}], AngerTime:1000000, Health: 10}
...
execute at @e[type=wither,limit=1,sort=nearest] as @e[limit=1,sort=random,nbt={Tags:["sMarked"]}] at @s run summon wither_skeleton ~ ~.01 ~ {DeathLootTable: "wither:entities/withermobs", Tags: ["wSkel"], Attributes: [{Name: "max_health", Base: 15}], Health: 15}
