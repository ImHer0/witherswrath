...
# ON
execute if data storage wither:options {toggledestruction:0} as @p run schedule function wither:wither/toggle/tdestructionon 1t
...
# OFF
execute if data storage wither:options {toggledestruction:1} as @p run schedule function wither:wither/toggle/tdestructionoff 1t
