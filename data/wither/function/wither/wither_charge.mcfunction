scoreboard players set @e[type=minecraft:armor_stand,limit=1,sort=nearest,tag=wStand] wcharge 100
...
execute run schedule function wither:wither/wither_charge2 1s