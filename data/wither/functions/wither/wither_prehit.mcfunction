...
execute if entity @e[type=wither,scores={Health=310..600}] as @e[type=minecraft:wither] at @s run summon minecraft:creeper ~ ~-1 ~ {CustomName:'"The Wither"',ExplosionRadius:4,Invulnerable:1,Fuse:1,ignited:1,Silent:1}
