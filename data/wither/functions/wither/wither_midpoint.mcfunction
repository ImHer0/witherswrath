...
execute as @e[type=wither,limit=1,sort=nearest] run summon wither_skeleton ~ ~ ~ {DeathLootTable:"wither:entities/wskeleton",Attributes:[{Name:"generic.max_health",Base:80}],Health:100,HandItems:[{Count:1,id:"bow"}],ArmorItems:[{},{},{Count:1,id:"chainmail_chestplate"}]}
execute as @e[type=wither,limit=1,sort=nearest] at @s run summon blaze ~ ~3 ~ {DeathLootTable:"wither:entities/wskeleton",Motion:[0.8d,0.6d,0d],Invulnerable:1,Tags:["wArcher"],Attributes:[{Name:"generic.max_health",Base:60}],Health:60,Passengers:[{id:"wither_skeleton",Attributes:[{Name:"generic.max_health",Base:51}],Health:51,HandItems:[{Count:1,id:"bow"}],ArmorItems:[{},{},{Count:1,id:"chainmail_chestplate"}]}]}
execute as @e[type=wither,limit=1,sort=nearest] at @s run summon blaze ~ ~3 ~ {DeathLootTable:"wither:entities/wskeleton",Motion:[0d,0.6d,0.8d],Invulnerable:1,Tags:["wArcher"],Attributes:[{Name:"generic.max_health",Base:60}],Health:60,Passengers:[{id:"wither_skeleton",Attributes:[{Name:"generic.max_health",Base:51}],Health:51,HandItems:[{Count:1,id:"bow"}],ArmorItems:[{},{},{Count:1,id:"chainmail_chestplate"}]}]}
execute as @e[type=wither,limit=1,sort=nearest] at @s run summon blaze ~ ~3 ~ {DeathLootTable:"wither:entities/wskeleton",Motion:[-0.8d,0.6d,0d],Invulnerable:1,Tags:["wArcher"],Attributes:[{Name:"generic.max_health",Base:60}],Health:60,Passengers:[{id:"wither_skeleton",Attributes:[{Name:"generic.max_health",Base:51}],Health:51,HandItems:[{Count:1,id:"bow"}],ArmorItems:[{},{},{Count:1,id:"chainmail_chestplate"}]}]}
execute as @e[type=wither,limit=1,sort=nearest] at @s run summon blaze ~ ~3 ~ {DeathLootTable:"wither:entities/wskeleton",Motion:[0d,0.6d,-0.8d],Invulnerable:1,Tags:["wArcher"],Attributes:[{Name:"generic.max_health",Base:60}],Health:60,Passengers:[{id:"wither_skeleton",Attributes:[{Name:"generic.max_health",Base:51}],Health:51,HandItems:[{Count:1,id:"bow"}],ArmorItems:[{},{},{Count:1,id:"chainmail_chestplate"}]}]}
execute as @e[type=wither,limit=1,sort=nearest] at @e[type=player,distance=..20] run summon area_effect_cloud ~ ~ ~ {CustomName:'',CustomNameVisible:1,Radius:3f,Duration:200,RadiusOnUse:-0.01f,RadiusPerTick:-0.0002f,ReapplicationDelay:40,Effects:[{Duration:200,Id:20b,Amplifier:4b},{Duration:40,Id:9b,Amplifier:1b}]}
