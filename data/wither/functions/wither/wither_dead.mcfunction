...
# PEACE
execute at @e[type=item,sort=nearest,nbt={Item:{id:"minecraft:nether_star"}}] run kill @e[type=wither_skeleton,distance=..80]
execute at @e[type=item,sort=nearest,nbt={Item:{id:"minecraft:nether_star"}}] run kill @e[type=blaze,distance=..80]
execute at @e[type=item,sort=nearest,nbt={Item:{id:"minecraft:nether_star"}}] run kill @e[type=zombie,distance=..40]
execute at @e[type=item,sort=nearest,nbt={Item:{id:"minecraft:nether_star"}}] run kill @e[type=skeleton,distance=..40]
execute at @e[type=item,sort=nearest,nbt={Item:{id:"minecraft:nether_star"}}] run kill @e[type=creeper,distance=..40]
