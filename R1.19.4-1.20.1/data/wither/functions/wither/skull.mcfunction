...
execute at @e[type=minecraft:wither_skull,tag=buff,limit=1] run summon creeper ~ ~-1 ~ {ExplosionRadius:2b,Fuse:0,Tags:["boom"],CustomName:'"wither skull"',ActiveEffects:[{Id:20,Amplifier:1b,Duration:4}]}
