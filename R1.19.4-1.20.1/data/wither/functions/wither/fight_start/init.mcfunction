...
execute as @e[type=minecraft:wither,limit=1,sort=nearest] if data storage wither:options {toggleanimation:Default} unless block ^ ^ ^1 minecraft:bedrock unless block ^ ^ ^2 minecraft:bedrock unless block ^ ^ ^3 minecraft:bedrock unless block ~ ~-1 ~ minecraft:bedrock unless block ~ ~-2 ~ minecraft:bedrock unless block ~ ~1 ~ minecraft:bedrock unless block ~ ~2 ~ minecraft:bedrock unless block ~ ~3 ~ minecraft:bedrock unless block ~ ~4 ~ minecraft:bedrock unless block ~ ~5 ~ minecraft:bedrock run data merge entity @s {ActiveEffects:[{Id:25,Amplifier:3b,Duration:140,ShowParticles:0b},{Id:28,Amplifier:20b,Duration:400,ShowParticles:0b}]}
...
execute as @e[type=minecraft:wither,limit=1,sort=nearest] at @s run data merge entity @s {Health:600f,Tags:["Bedrock","Charge","Wither","Dash","Swarm"],ArmorItems:[{id:"minecraft:leather_boots",Count:1b,tag:{Enchantments:[{id:"minecraft:blast_protection",lvl:255s}],Unbreakable:1b}},{id:"minecraft:iron_leggings",Count:1b,tag:{Unbreakable:1b,Enchantments:[{id:"minecraft:blast_protection",lvl:255s}]}},{id:"minecraft:iron_chestplate",Count:1b,tag:{Unbreakable:1b,Enchantments:[{id:"minecraft:blast_protection",lvl:255s}]}},{id:"minecraft:leather_helmet",Count:1b,tag:{Unbreakable:1b,Enchantments:[{id:"minecraft:blast_protection",lvl:255s}]}}],ArmorDropChances:[-327.67f,-327.67f,-327.67f,-327.67f],Attributes:[{Name:"minecraft:generic.follow_range",Base:69},{Name:"minecraft:generic.knockback_resistance",Base:0.5},{Name:"minecraft:generic.max_health",Base:600},{Name:"minecraft:generic.movement_speed",Base:2},{Name:"minecraft:generic.armor",Base:1},{Name:"minecraft:generic.armor_toughness",Base:0},{Name:"minecraft:generic.flying_speed",Base:5}]}
