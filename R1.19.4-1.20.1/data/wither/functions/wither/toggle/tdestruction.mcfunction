...
# ON
execute if data storage wither:options {toggledestruction:Disabled} as @p run schedule function wither:wither/toggle/tdestructionon 1t
...
# OFF
execute if data storage wither:options {toggledestruction:Enabled} as @p run schedule function wither:wither/toggle/tdestructionoff 1t
