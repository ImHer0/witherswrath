execute if data storage wither:options {toggleanimation:Default} at @e[type=minecraft:wither,limit=1,sort=nearest] at @s run particle minecraft:cloud ~ ~1 ~ 1.5 1.8 1.5 0.1 100 normal
