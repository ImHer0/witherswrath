...
execute as @e[type=minecraft:wither] at @s run summon minecraft:creeper ~ ~1 ~ {Team:"Wither",CustomName:'{"text":"The Wither\'s Instability"}',ExplosionRadius:10,Invulnerable:1b,Fuse:0,ignited:1b,Silent:1b}
data merge entity @e[type=minecraft:wither,limit=1,sort=nearest] {CustomNameVisible:0b,NoAI:0b,Attributes:[{Name:"minecraft:generic.armor",Base:6},{Name:"minecraft:generic.armor_toughness",Base:6}]}
...
execute at @e[type=wither,limit=1,sort=nearest] run particle minecraft:electric_spark ~ ~0.8 ~ 0.3 0.5 0.3 8 400 normal
