...
execute as @e[type=minecraft:wither,limit=1,sort=nearest] at @s unless entity @e[type=wither_skeleton,distance=..10] at @s run summon wither_skeleton ~ ~ ~ {Team:"Wither",DeathLootTable: "wither:entities/withermobs", Tags: ["wSkel"], Attributes:[{Name:"minecraft:generic.max_health",Base:50}], ArmorItems:[{id:"minecraft:netherite_boots",Count:1b,components:{"minecraft:unbreakable":{show_in_tooltip:false},"minecraft:trim":{material:"minecraft:diamond",pattern:"minecraft:silence",show_in_tooltip:false}}},{},{},{}],ArmorDropChances:[-327.670F,0.085F,0.085F,0.085F], Health: 50}
