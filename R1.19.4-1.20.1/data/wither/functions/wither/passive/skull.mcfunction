...
execute at @e[type=minecraft:wither_skull,nbt={dangerous:0b},tag=buff,limit=1] run summon creeper ~ ~-.1 ~ {ExplosionRadius:2b,Fuse:0,Tags:["boom"],CustomName:'{"text":"wither skull"}',ActiveEffects:[{Id:20,Amplifier:1b,Duration:4}],Attributes:[{Name:"minecraft:generic.scale",Base:0.0625}]}
...
execute at @e[type=minecraft:wither_skull,nbt={dangerous:1b},tag=buff,limit=1] run summon creeper ~ ~-0.1 ~ {ExplosionRadius:3b,Fuse:0,Tags:["bigboom"],CustomName:'{"text":"wither nuke"}',ActiveEffects:[{Id:20,Amplifier:3b,Duration:4}],Attributes:[{Name:"minecraft:generic.scale",Base:0.0625}]}
