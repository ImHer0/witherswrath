...
execute unless score enraged wenraged matches 1 as @e[type=minecraft:wither,limit=1,sort=nearest] run data merge entity @s {ActiveEffects:[{Id:11,Amplifier:255b,Duration:60,ShowParticles:0b}]}
execute if score enraged wenraged matches 1 as @e[type=minecraft:wither,limit=1,sort=nearest] run data merge entity @s {ActiveEffects:[{Id:11,Amplifier:255b,Duration:180,ShowParticles:0b}]}
