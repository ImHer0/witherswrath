...
# DAYBREAK
    execute if data storage wither:options {toggleweather:Enabled} run execute if data storage wither:options {toggleweather:Enabled} run weather clear 10000t
    execute if data storage wither:options {toggleweather:Enabled} run execute if data storage wither:options {toggleweather:Enabled} run gamerule doDaylightCycle true
