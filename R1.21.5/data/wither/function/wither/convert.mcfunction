...
execute at @e[type=wither,limit=1,sort=nearest] as @e[type=zombie,limit=1,sort=random,distance=..40,tag=] unless data entity @s CustomName run data merge entity @s {Tags:["zMarked"]}
execute at @e[type=wither,limit=1,sort=nearest] as @e[type=husk,limit=1,sort=random,distance=..40,tag=] unless data entity @s CustomName run data merge entity @s {Tags:["zMarked"]}
...
execute at @e[type=wither,limit=1,sort=nearest] as @e[type=#minecraft:skeletons,limit=1,sort=random,distance=..40,tag=] unless data entity @s CustomName run data merge entity @s {Tags:["sMarked"]}
