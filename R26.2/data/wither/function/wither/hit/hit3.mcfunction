...
execute as @e[type=wither,scores={Health=..250}] if data storage wither:options {togglecharge:Enabled} at @s run function wither:wither/phase2/charge/chargepre
