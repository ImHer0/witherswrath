...
execute at @e[type=minecraft:wither_skull,nbt={dangerous:0b},tag=buff,limit=1] run summon creeper ~ ~-.1 ~ {ExplosionRadius:2b,Fuse:0,Tags:["boom"],CustomName:'{"text":"wither skull"}',active_effects:[{id:"minecraft:wither",amplifier:1,duration:4}],Attributes:[{Name:generic.scale,Base:0.0625}]}
...
execute at @e[type=minecraft:wither_skull,nbt={dangerous:1b},tag=buff,limit=1] run summon creeper ~ ~-0.1 ~ {ExplosionRadius:3b,Fuse:0,Tags:["bigboom"],CustomName:'{"text":"wither nuke"}',active_effects:[{id:"minecraft:wither",amplifier:3,duration:4}],Attributes:[{Name:generic.scale,Base:0.0625}]}
