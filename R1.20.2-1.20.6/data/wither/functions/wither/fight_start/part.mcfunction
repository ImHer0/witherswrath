execute if data storage wither:options {toggleanimation:Default} as @e[type=minecraft:wither,limit=1,sort=nearest] at @s run particle minecraft:cloud ~ ~1 ~ 0.9 1.2 0.9 0.001 100 normal
