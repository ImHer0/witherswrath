...
function wither:wither/fight_start/part_trail
...
execute as @e[type=minecraft:wither,limit=1,sort=nearest] at @s run data merge entity @e[type=wither,limit=1,sort=nearest] {Health:600f,Tags:["Bedrock","Charge","Wither","Dash","Swarm"],ArmorItems:[{id:"minecraft:leather_boots",Count:1b,components:{"minecraft:enchantments":{levels:{"minecraft:blast_protection":255}},"minecraft:unbreakable":{}}},{id:"minecraft:iron_leggings",Count:1b,components:{"minecraft:unbreakable":{},"minecraft:enchantments":{levels:{"minecraft:blast_protection":255}}}},{id:"minecraft:iron_chestplate",Count:1b,components:{"minecraft:unbreakable":{},"minecraft:enchantments":{levels:{"minecraft:blast_protection":255}}}},{id:"minecraft:leather_helmet",Count:1b,components:{"minecraft:unbreakable":{},"minecraft:enchantments":{levels:{"minecraft:blast_protection":255}}}}],ArmorDropChances:[-327.670F,-327.670F,-327.670F,-327.670F],Attributes:[{Name:"minecraft:generic.follow_range",Base:69},{Name:"minecraft:generic.knockback_resistance",Base:0.5},{Name:"minecraft:generic.max_health",Base:600},{Name:"minecraft:generic.movement_speed",Base:2},{Name:"minecraft:generic.step_height",Base:2},{Name:"minecraft:generic.armor",Base:1},{Name:"minecraft:generic.armor_toughness",Base:0},{Name:"minecraft:generic.flying_speed",Base:5}]}
