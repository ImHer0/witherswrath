...
execute as @e[type=minecraft:wither,limit=1,sort=nearest] at @s run summon minecraft:wither_skull ^ ^3 ^ {Tags:["skulllaunch"],Motion:[0.05,0.09,0.05],Fire:200,CustomName:'{"text":"Wither Missile"}'}
...
schedule function wither:wither/phase2/launchskullend 2s
