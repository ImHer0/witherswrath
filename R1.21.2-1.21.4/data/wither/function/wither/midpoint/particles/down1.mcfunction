...
execute at @e[type=minecraft:wither,limit=1,sort=nearest] run particle minecraft:soul_fire_flame ~ ~ ~ .5 0.2 .5 0.0000001 200 force @e[distance=..20,type=player]
execute at @e[type=minecraft:wither,limit=1,sort=nearest] run particle minecraft:large_smoke ~ ~ ~ .5 0.2 .5 0.0000001 300 force @e[distance=..20,type=player]
