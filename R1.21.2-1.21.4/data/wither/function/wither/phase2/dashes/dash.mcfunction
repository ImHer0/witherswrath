...
execute unless entity @e[type=minecraft:armor_stand,limit=1,sort=nearest,tag=chargew] unless entity @e[type=minecraft:armor_stand,limit=1,sort=nearest,tag=wStand] run function wither:wither/phase2/dashes/dashto
