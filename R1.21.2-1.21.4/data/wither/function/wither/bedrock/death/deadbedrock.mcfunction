...
execute as @e[type=minecraft:wither,limit=1] run data merge entity @e[type=wither,limit=1] {Tags:["bedrockdeath"],HasVisualFire:1b,Silent:1b,Glowing:1b,Health:1f,attributes:[{id:"minecraft:generic.max_health",base:1000}]}
