execute if data storage wither:options {toggleanimation:Default} at @e[type=minecraft:wither,limit=1,sort=nearest] at @s run particle dust_color_transition{from_color:[0.600,0.600,0.600],scale:3,to_color:[1.000,1.000,1.000]} ~ ~1 ~ 0.9 1.2 0.9 0.001 100 normal
