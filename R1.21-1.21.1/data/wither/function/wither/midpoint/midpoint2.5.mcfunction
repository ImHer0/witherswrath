...
execute as @e[type=minecraft:wither] at @s run summon minecraft:creeper ~ ~1 ~ {Team:"Wither",CustomName: '"The Wither\'s Instability"', ExplosionRadius: 10, Invulnerable: 1b, Fuse: 0, ignited: 1b, Silent: 1b, attributes:[{id:"minecraft:generic.scale",base:0.0625}]}
data merge entity @e[type=minecraft:wither,limit=1,sort=nearest] {CustomNameVisible: 0b, NoAI: 0b, attributes:[{id:"minecraft:generic.armor",base:6},{id:"minecraft:generic.armor_toughness",base:6}]}
