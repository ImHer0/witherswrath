...
# GO UP GO DOWN 
execute if data storage wither:options {toggleanimation:Default} at @e[type=wither,limit=1,sort=nearest] run summon armor_stand ~ ~ ~ {Invisible:1b,Tags:["midpointpos"],attributes:[{id:"minecraft:generic.scale",base:2}]}
