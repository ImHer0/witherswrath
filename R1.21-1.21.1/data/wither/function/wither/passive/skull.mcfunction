...
execute at @e[type=minecraft:wither_skull,nbt={dangerous:0b},tag=buff,limit=1] run summon creeper ~ ~-.1 ~ {Team:"Wither",ExplosionRadius:2b,Fuse:0,Tags:["boom"],CustomName:'"wither skull"',active_effects:[{id:"minecraft:wither",amplifier:1,duration:4}],attributes:[{id:"minecraft:generic.scale",base:0.0625}]}
...
execute at @e[type=minecraft:wither_skull,nbt={dangerous:1b},tag=buff,limit=1] run summon creeper ~ ~-0.1 ~ {Team:"Wither",ExplosionRadius:3b,Fuse:0,Tags:["bigboom"],CustomName:'"wither nuke"',active_effects:[{id:"minecraft:wither",amplifier:3,duration:4}],attributes:[{id:"minecraft:generic.scale",base:0.0625}]}
