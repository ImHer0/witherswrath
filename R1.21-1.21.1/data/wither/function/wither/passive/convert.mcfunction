...
execute at @e[type=wither,limit=1,sort=nearest] as @e[limit=1,sort=random,nbt={Tags:["zMarked"]}] at @s run summon zombified_piglin ~ ~.01 ~ {DeathLootTable: "wither:entities/withermobs", Tags: ["wSkel"], attributes: [{id: "minecraft:generic.max_health", base: 10}], AngerTime:1000000, Health: 10}
