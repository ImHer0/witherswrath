...
execute as @e[type=wither,scores={Health=..100}] if data storage wither:options {toggleanimation:0} if data storage wither:options {toggledash:1} at @s run function wither:wither/enraged/enraged
